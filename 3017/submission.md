...
```text
โจทย์ต้องการให้เขียนโปรแกรมคิดค่าใช้จ่ายที่ลูกค้าต้องจ่ายทั้งหมดในการกินข้าวที่ร้านอาหาร
input : จำนวนเงินของอาหารและเครื่องดื่มยังไม่รวมค่ายริการและvat รับค่าเป็นจำนวนเต็ม
output : โจทย์ต้องการให้แสดงจำนวนเงินที่ลูกค่าต้องชำระทั้งหมด หลังจากที่คำนวณค่าบริการและVatแล้ว
```
...
```text
แผนแรกคือสร้างค่ามารับinputจำนวนเงินของค่าอาหารหลังจากนั้นก็นำค่าอาหารมาคิดเป็นค่าserviceโดยใช้สูตรตามโจทย์ หลังจากนั้นเขียนเงื่อนไขคือ ถ้าค่าserviceที่คิดมาแล้วน้อยกว่า50จะคิดเป็นค่าบริการ50เลย เพราะโจทย์บอกให้ขั้นต่ำ50บาท หลังจากนั้นก็ลองเขียนเงื่อนไขต่อมาคือ ถ้าserviceมากกว่า1000 จะคิดแค่1000เพราะโจทย์กำหนดให้คิดค่าบริการไม่เกิน1000 หลังจากนั้นก็เอาราคาค่าอาหารมาบวกกับค่าบริการ จากนั้นนำมาหารกับ7%เพื่อหาราคาvat หลังจากนั้นก็นำทั้งหมดมาบวกกันก็คือ ค่าอาหาร+ค่าบริการ+vat ก็จะได้คำตอบออกมา
```
...
```text
ใช้วิธีตามที่วางแผนไว้เลยคือ รับค่าinputมาเป็นราคาอาหาร หลังจกานั้นนำมาคิดค่าบริการผ่านสูตรตามโจทย์และif else ตามที่เขียนไว้ในแผนแรก แล้วก็นำมาคิดค่าvat จากนั้นนำค่าทั้งหมดมาบวกกันก็ได้จำนวนเงินที่ลูกค้าต้องจ่ายทั้งหมด
```
...
```text
ลองดูว่าเงื่อนไขของการคิดค่าบริการใช้ได้จริงมั้ย 
```
...
```text
อยากรู้ว่าถ้าหากว่าค่าอาหารเป็นค่าทศนิยม จะสามารถรันได้อยู่มั้ย ซึ่งก็ไม่ได้ ถ้าหากว่าอยากให้รันได้ก็ควรรับค่าเป็นfloat
```
...
```text
File "c:\Users\mario\OneDrive\Documents\GitHub\PSCP-69070201\3017\main.py", line 5, in main
    price = int(input())
```
...
```text
ทดสอบว่าหากลองรับเลขมากๆ จะยังสามรถคิดค่าได้อย่างถูกต้องมั้ย ถูกตามที่เงื่อนไขค่าบริการกำหนดไว้มั้ย
```
