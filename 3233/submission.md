...
```text
โจทย์ให้ผมรับผลหวยที่ถูกรางวัลมา 1 ชุด และรับเลขของผมอีก 1 ชุด จากนั้นนำตัวอักษรและตัวเลขของทั้งสองชุดมาเปรียบเทียบกันเพื่อคำนวณว่าผมถูกรางวัลเป็นเงินเท่าไรตามเงื่อนไขที่กำหนด
```
...
```text
ผมจะรับผลรางวัลและเลขของผมมาเปรียบเทียบกันทีละเงื่อนไข โดยตรวจจากรางวัลที่มากที่สุดไปน้อยที่สุด แล้วกำหนดจำนวนเงินตามเงื่อนไขที่ตรงกันก่อนแสดงผลเครดิตฟรี
```
...
```text
วิธีสุดท้ายของผมเหมือนกับแผนแรก ผมใช้ if-elif ตรวจเงื่อนไขการถูกรางวัลจากรางวัลที่มีเงินมากไปน้อยแล้วกำหนดเงินรางวัลตามเงื่อนไขที่ตรงกัน ก่อนนำจำนวนเงินที่ได้มาแสดงผล
```
...
```text
ตรวจว่าโปรแกรมเลือกเงินรางวัล 100000ไหม เมื่อเลขตรงทั้งหมดแต่ตัวอักษรไม่ตรงและไม่เผลอไปคิดเป็นรางวัลเลขท้าย
```
...
```text
ตรวจเงื่อนไขที่ต้องได้ 2000และดูว่าโปรแกรมไม่ไปเข้าเงื่อนไขเลขท้าย 2 ตัวแทน
```
...
```text
ตรวจกรณีที่ไม่มีเงื่อนไขใดตรงกันเพื่อดูว่าโปรแกรมให้ผลเป็น 0 ถูกต้อง
```
