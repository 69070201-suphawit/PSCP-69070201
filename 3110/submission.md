...
```text
โจทย์ต้องการให้เราคิดค่าธรรมเนียมการส่งพัสดุโดยที่inputคือต้นทางและปลายทาง และโจทย์ต้องการให้อินพุทต้นทางปลายทางอยู่บรรทัดเดียวกัน จึงต้องใช้.splitและต้องมีน้ำหนักของตัวพัสดุด้วย outputคือราคาที่คิดค่าธรรมเนียมมาเรียบร้อยแล้วและต้องมีทศนิยม2ตำแหน่ง และหากชื่อต้นทางหรือปลายทางไม่ถูกต้อง ไม่มีอยู่จริงoutputจะเป็นError
```
...
```text
แผนแรกผมลองรับอินพุทก่อน จากนั้นนำเข้าฟังก์ชั่นif else ทำเงื่อนไขต่างๆให้ครบ จากนั้นลองแสดงผล
```
...
```text
ผมใช้วิธีเดียวกับแผนแรกโดยที่ผมรับอินพุทมาก่อน แล้วนำมาเข้าสูตรif else เช่น ถ้าหากต้นทางคือกรุงเทพ ปลายทางเชียงใหม่ ก็จะใส่สูตรเป็น ค่าธรรมเนียม + (น้ำหนักของสิ่งของ * ค่าธรรมเนียมน้ำหนัก) ถ้าถูกให้แสดงราคาทั้งหมดมา หากไม่ถูกให้แสดง Error
```
...
```text
เช็กว่าโปรแกรมคิดเฉพาะค่าบริการพื้นฐานทำได้มั้ย
```
...
```text
เช็กว่าโปรแกรมเข้า else และแสดง Errorไหม
```
...
```text
เช็กว่าโปรแกรมรองรับ float และแสดงผล 2 ตำแหน่ง
```
