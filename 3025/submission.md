...
```text
โจทย์ต้องการให้เราหาว่าเดือนนี้วันนี้เป็นฤดูกาลอะไร โดยที่input คือเดือน และวัน outputที่ต้องการคือบอกว่านี่คือฤดูกาลไหน
```
...
```text
รับอินพุทมาก่อน จากนั้นลองเขียนฟังก์ชั่นif else โดยที่ถ้าหากเป็นเดือนที่หาร3ลงตัวและวันมากกว่าเท่ากับ21 จะเปลี่ยนฤดู
```
...
```text
ใช้วิธีเดียวกกกับแผนแรกคือ รับอินพุทมา แล้วเขียนif else หากเดือนอยู่ในเดือนทีหาร3ไม่ลงตัว จะแสดงผลฤดูตามที่เดือนนั้นควรจะเป็น แต่หากเป็นวันที่21เดือนที่หาร3ลงตัว จะแสดงผลเป็นฤดูถัดไป 
```
...
```text
อยากรู้ว่าเดือนที่ไม่มีอยู่ตรงใส่ไปจะแสดงผลมั้ย
```
...
```text
ลองดูว่าวันที่31มันจะรันได้มั้ย
```
...
```text
ลองดูว่าถ้าวันใส่มั่วๆจะรันได้มั้ย
```
