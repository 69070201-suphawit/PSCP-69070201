...
```text
โจทย์อยากให้เราหาคะแนนสะสมแต้ม โดยอินพุทคือ : จำนวนแต้ม และ แต้ม+หรือ- เอ้าพุทคือจำนวนแต้มทั้งหมดหลังจากบวกลบแล้ว
```
...
```text
ทีแรกผมระยอินพุทมาก่อน แล้วสร้างค่าtotalมา จากนั้นนำมาเข้าฟังชั่นทหากเป็นบวกให้บวกเข้า หากเป็นลบก็ให้ลบ จากนั้นก็แสดงผลออกมา
```
...
```text
ใช้เหมือนวิธีแรกคือ ผมกำหนดtotalมาเข้าฟังชั้น ถ้าบวกก็+=เข้าไปในtotal ลบก็ทำเช่นกันแต่เปลี่ยนเป็นลบ และแสดงค่าออกมา
```
