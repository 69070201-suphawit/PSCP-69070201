...
```text
โจทย์ให้รับสี RGB 2 สีแล้วหาค่าเฉลี่ยของแต่ละช่องสีแยกกันพิมพ์เป็นจำนวนเต็ม 3 ค่าคั่นด้วยช่องว่าง
```
...
```text
รับสีที่ 1และสีที่ 2 แยกเป็น R, G, B จากนั้นบวกช่องเดียวกันของสองสีแล้วหารด้วย 2ทีละช่องแล้วค่อยพิมพ์ 3 ค่าที่ได้คั่นด้วยช่องว่าง
```
...
```text
วิธีสุดท้ายเหมือนแผนแรกเกือบทั้งหมดคือรับสี 2 สีบวกแต่ละช่องของสองสีเข้าด้วยกันแล้วหาร 2 พิมพ์ 3ค่าคั่นด้วยช่องว่างต่างกันแค่รายละเอียดว่าใช้ //เพื่อตัดทศนิยมทิ้งซึ่งเพิ่มเข้ามา
```
...
```text
ตรวจการตัดทศนิยมในทุกช่องพร้อมกัน
```
