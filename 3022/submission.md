...
```text
โจทย์ต้องการให้เราแปลงอุณหภูมิโดยการที่inputคือตัวอุณหภูมิ ตัวอักษรตัวย่อของอุณหภูมิที่1  ตัวอักษรตัวย่อของอุณหภูมิที่2 โดยที่outputควรจะเป็นอุณหภูมิที่ถูกแปลงมาแล้ว
```
...
```text
ทีแรกผมลองเขียนอินพุทมาก่อน โดยตัวแรกรับค่าตัวเลขอุณหภูมิ เป็นfloatเพื่อรับค่าทศนิยมด้วย และรับค่าอินพุทตัวที่2และ3เป็นstrเพื่อรับค่าตัวย่อขององศา1และ2 โดยที่outputควรจะเป็นตามที่ต้องการคืออุณหภูมิที่แก้แล้ว
```
...
```text
ผมรับค่าอินพุทตามที่กล่าวไปทีแรก โดยที่แทนสูตรแปลงอุณหภูมิไป โดยการใช้serch engineหาสูตร แล้วเขียนif elseไปเรื่อยๆ โดยแปลงให้เป็นองศาเซียลเซียสก่อน จากนั้นค่อยนำค่าที่แปลงเป็นองศาเรียบร้อยแล้วมาแปลงเป็นอุณหภูมิที่ต้องการหาเก็บค่าไว้ในตัวแปรtempulature_c จากนั้นแสดงผลเป็นทศนิยม2จุด
```
...
```text
อยากรู้ว่าถ้าหากเอาอุณหภูมิที่สูงมากๆและมีทศนิยมมาใส่จะใช้ได้มั้ย
```
...
```text
อยากรู้ว่าถ้าเอาตัวอักษรอื่นที่ไม่ใช่ตัวC F K Rมาจะรันได้มั้ย
```
...
```text
อยากรู้ว่าถ้าหากเอาCแปลงเป็นCโค้ดมันจะรันได้มั้ย มันจะงงมั้ย
```
