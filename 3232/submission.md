...
```text
โจทย์ให้ผมรับค่าความสูงของการกระโดดครั้งแรก x และระยะทางที่กบต้องการกระโดด y จากนั้นคำนวณว่ากบต้องกระโดดกี่ครั้งจึงจะเดินทางถึงหรือเกินระยะ y โดยทุกครั้งที่กระโดดระยะการกระโดดของกบจะลดลงครั้งละ 2 และถ้าระยะกระโดดลดลงจนเป็น 0 หรือติดลบก่อนถึงเป้าหมาย ให้แสดง -1
```
...
```text
ผมคิดว่าผมจะรับค่า x และ yก่อน จากนั้นเริ่มสะสมระยะทางจาก 0 เริ่ม กระโดดครั้งละ x และเพิ่มจำนวนครั้งแล้วก็ลดระยะกระโดดลง 2 ทุกครั้ง ทำซ้ำจนกว่าจะถึงหรือเกิน y ถ้าระยะกระโดดหมดก่อนถึงเป้าหมายให้แสดง -1
```
...
```text
วิธีสุดท้ายของผมเหมือนกับแผนแรก เพราะผมใช้ while เพื่อจำลองการกระโดดของกบ โดยสะสมระยะทางและนับจำนวนครั้งที่กระโดดไปเรื่อย ๆ พร้อมลดระยะกระโดดลงครั้งละ 2 ถ้าถึงหรือเกินระยะเป้าหมายก็หยุด แต่ถ้าระยะกระโดดหมดก่อนถึงเป้าหมายจะให้คำตอบเป็น -1
```
...
```text
ตรวจว่าการเพิ่มระยะทางและลดระยะกระโดดในแต่ละรอบทำงานถูกต้อง
```
...
```text
ตรวจกรณีพิเศษที่ไม่จำเป็นต้องกระโดดเลย
```
...
```text
ตรวจกรณีที่ระยะกระโดดลดลงจนไม่สามารถเดินทางต่อไปถึงเป้าหมายได้
```
