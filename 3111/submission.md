...
```text
รับค่าก่อนว่าเป็นสมาชิกไหม จากนั้นก็รับค่าจำนวนสินค้าที่ซื้อ แล้วก็รับค่าราคาสินค้าnบรรทัด โดยที่โจทย์ต้องการเอ้าพุตเป็นยอดรวมหลังจากรวมส่วนลดทศนิยม2ตำแหน่ง
```
...
```text
รับค่ามาก่อน จากนั้นลองนำมาเข้าลูปตามจำนวนชิ้นของสิ่งของ จากนั้นมารับค่าจำนวนราคาในล๔ปตามจำนวนของ จากนั้นนำมาตรวจสอบว่าเป็นสมาชิกมั้ยถ้าเป็นก็ลดราคาแต่ถ้าไม่เป็นสมาชิก แต่ไม่เป็นสมาชิก ลดราคา3% กรณีอื่นไม่ลดจากนั้นนำมาเข้าสูตรคิดราคา แล้วนำมาปัดเศษให้เป็นทศนิยม2ตำแหน่งแล้วคิดสดงเอ้าพุตออกมา
```
...
```text
วิธีของผมเหมือนแผนแรกคือรับค่ามา แล้วเอามาใส่ลูป จากนั้นตรวจสอบว่าเป็นสมาชิกมั้ย ซื้อของกี่บาท ได้ส่วนลดมั้ย แล้วค่อยนำคำตอบมาเข้าสูตรลดราคาปัดเศษแล้วแสดงผล
```
...
```text
ไม่เป็นสมาชิก และยอดรวมน้อยกว่า500
```
