...
```text
รับค่าจำนวนร้านกับจำนวนช่วงเวลา แล้วก็รับเวลาเปิดปิด จากนั้นรับป้อนเวลาที่ต้องการตรวจสอบ โดยเอ้าพุตคือจำนวนร้านที่เปิดใกล้ๆในเวลานั้น
```
...
```text
แผนแรกผมรับค่ามาก่อน จากนั้นเอาcountมาสร้างลิจส์จากนั้นเวลา1วันมาคูณ จากนั้นนำมาเข้าลูป เช้คร้านค้าทีละร้านรับค่าร้านร้านเริ่มต้น ร้านสุดท้ายจากนั้นนำเริ่มต้นสิ้นสุด มาหาค่า จากนั้นนำมาบวกเข้าในcount ก็จะรู้นาทีนั้นมีร้านเปิดรวมกันกี่ร้าน จากนั้นกำหนดเวลามาลูป ในrange check กำหนดiเป้นkแล้วก็ปริ้นออกมา
```
...
```text
เหมือนวิธีแรก คือรับค่าก่อน จากนั้นนำมาหาว่ามีร้านเปิดใกล้ๆมั้ย รวมกันกี่นาทีจากนั้นกำหนดเวลา แล้วนำมาลูปแล้วปริ้นออกมา
```
...
```text
ร้านเดียว เช็คตอนเปิดกับตอนปิด
```
