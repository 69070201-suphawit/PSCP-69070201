...
```text
โจทย์ให้รับข้อความ 5 บรรทัด(บรรทัดว่างก็นับ)แล้วแสดงในกรอบ * โดยข้อความต้องชิดซ้าย และความกว้างกรอบขึ้นกับบรรทัดที่ยาวที่สุด รวมเป็น output 7 บรรทัด
```
...
```text
ลองให้โจทย์รับข้อความ5บรรทัดหาความยาวสูงสุดแล้วพิมพ์ขอบดาว ตามด้วยแต่ละบรรทัดในรูป ดาว + แล้วก็ข้อความเติมช่องว่างท้ายให้ยาว w + ดาว แล้วปิดด้วยขอบล่างแบบเดียวกัน
```
...
```text
วิธีสุดท้ายที่ใช้ในโค้ดเหมือนกับแผนแรกคือรับข้อความก่อน 5 บรรทัดจากนั้นหาความยาวสูงสุด แล้วพิมพ์ขอบบน บรรทัดข้อความที่เติมช่องว่างท้ายให้ยาวเท่ากันและขอบล่าง
```
...
```text
บรรทัดยาวๆบรรทัดเดียวที่เหลือสั้นหรือว่าง
```
