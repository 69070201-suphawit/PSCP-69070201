...
```text
โจทย์ต้องการให้รับค่าและนำมาสลับเป็นข้อความกลับด้านและผลลัพธ์ต้องแสดงเป็นตัวเล็ก
input:โปรแกรมรับค่าตัวอักษรภาษาอังกฤษ
output:แปลงค่าจากinputโดยนำมาสลับข้อความผ่านคำสั่ง[::-1]และแปลงค่าเป็นตัวพิมพ์เล็กโดยคำสั่ง.lower
```
...
```text
ขั้นแรกผมอ่านโจทย์ดูว่าต้องการอะไรแล้วก็ลองรับค่าinputเป็นข้อความว่าได้มั้ยแล้วลองprintดู จากนั้นทดลองใช้คำสั่ง[::-1]เพื่อทดสอบว่าลดข้อความจริงมั้ยแล้วเช็คแล้วจึงมาเช็คคำสั่ง.lowerแยกทีหลัง หลังจากนั้นก็ลองเขียนโค้ดเต็มดู
...
```text
วิธีที่ใช้จริงก็ใช้วิธีเดียวกับที่ลองคิดไว้ ผมลองเอาค่าinputมารับแล้วใส่คำสั่ง [::-1]และ.lowerตามที่คิดไว้แล้วprint(result)ออกมาเพื่อแสดงค่าจนได้ผลลัพธ์ที่ต้องการ
```
...
```text
ตรวจสอบว่าสามารถทำให้inputที่เป็นตัวพิมพ์ใหญ่กลายเป็นoutputเตัวเล็กได้หรือไม่ บวกกับเป็นชื่อเล่นของตัวผมด้วย
```
...
```text
เพราะอยากทดลองว่าถ้าเกิดinputเป็นตัวใหญ่ทั้งหมดจะยังแสดงผลตัวเล็กทั้งหมดมั้ย
```
...
```text
ทดสอบว่านอกจากตัวอักษร ยังสามารถรับค่าที่เป็นตัวเลขได้มั้ย
```
...
| If I received human help, I disclosed it in this file. | Yes |
| I submitted the final code to the OJ by myself. | Yes |
>>>>>>> 8968d5fa4617caabbb6c0a12eb64d39bc47fff1c
