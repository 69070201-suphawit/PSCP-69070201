...
```text
โจทย์ให้ผมรับรหัสไพ่ 1 ใบ เช่น AS หรือ 10Hแล้วแยกส่วนของแต้มไพ่กับดอกไพ่ออกจากกันจากนั้นแปลงตัวย่อของแต้มและดอกให้เป็นชื่อเต็มแล้วแสดงผลในรูปแบบ rank of suit
```
...
```text
ผมจะรับรหัสไพ่มาจากนั้นแยกแต้มกับดอกไพ่ออกจากกันและแปลงตัวย่อของแต้มและดอกเป็นชื่อเต็มแล้วแสดงผลเป็นชื่อไพ่ที่อ่านได้ง่าย
```
...
```text
วิธีสุดท้ายของผมเหมือนกับแผนแรกเพราะผมใช้วิธีแยกรหัสไพ่ออกเป็นแต้มกับดอกก่อน แล้วนำไปตรวจสอบกับข้อมูลที่กำหนดไว้ใน dictionary เพื่อเปลี่ยนตัวย่อให้เป็นชื่อเต็ม จากนั้นจึงนำแต้มและดอกที่ได้มาแสดงผลในรูปแบบที่โจทย์ต้องการ
```
...
```text
ตรวจว่าการแยกแต้มด้วยcard[:-1]ยังทำงานถูกต้องกับเลขสองหลัก ไม่ได้แยกแค่ตัวแรก
```
...
```text
เป็นการทดสอบที่ต้องแปลงทั้งแต้มและดอกพร้อมกันเพื่อดูว่า dictionary ทั้งสองส่วนทำงานถูกต้อง
```
...
```text
ตรวจว่า .upper() ที่ใช้ในโค้ดสามารถทำให้ข้อมูลตัวพิมพ์เล็กถูกแปลงและประมวลผลได้ถูกต้อง
```
