...
```text
โจทย์ข้อนี้ต้องการให้หาดูว่าช่วงระหว่างAกับBมีจำนวนที่หารdแล้วเหลือเศษrกี่ตัว โดยอินพุทคือ A Bคือเอาไส้กำหนดช่วงที่จะหา dคือตัวหาร rคือเศษ
```
...
```text
ขั้นแรกผมลองรับอินพุทดูก่อน จากนั้นลองเอามาเข้าฟังก์ชั่นลูปดู โดยที่เก็บค่าไว้ในx และrangeคือA , B + 1 แล้วแทนสูตรifไปแล้วแสดงผล
```
...
```text
ผมทำตามแผนแรกที่คิดไว้ โดยที่รับอินพุทมาก่อน จากนั้นนำมาเข้าลูป โดยเก็บค่าไว้ที่x rangeคือ A,B และจากนั้นนำมาใส่ฟังก์ชั่นif else โดยที่สูตรคือx%d == r ก็คือนำจำนวนตัวเลขทั้งหมดที่อยู่ระหว่างA,B มาใช้ผ่านxที่เราเก็บค่าไว้ จากนั้นนำมาหารกับตัวการในอินพุท โดยที่ถ้าหากตัวไหนหารแล้วเศษเท่ากับค่าr ก็จะให้บวกเข้าไปในcountเป็นการนับว่ามีกกี่ตัวที่ได้เท่่านี้ จากนั้นก็แสดงผลออกมา
```
...
```text
เช็กว่าโปรแกรมทำงานได้แม้มีตัวเลขให้ตรวจแค่ 1 ตัว
```
...
```text
อยากรู้ว่าถ้าหากrangeเยอะๆจะยังทำงานได้มั้ย
```
