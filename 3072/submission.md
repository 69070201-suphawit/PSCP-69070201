...
```text
เริ่มจากการสร้างอินพุตก่อนโดยที่รับเป็นstrจากนั้น จากนั้นนำมาโปรแกรมมิ่งเพื่อให้ได้ผลลัพธ์เป็นจำนวนสระของคำๆนั้นนำมาแสดงว่ามีสระทั้งหมดกี่ตัว ไม่มีก็ไม่ต้องพิม
```
...
```text
แผนแรกผมรับอินพุทมาก่อนจากนั้นก็ลองเริ่มจากกดหนดว่าสระมีตัวอะไรบ้าง จากน้ั้นก็ทำลูปเพื่อตรวจสอบว่ามีสระมั้ย ถ้ามีก็ปริ้นมาแล้วบอกว่ามีกี่ตัว
```
...
```text
ผมทำตามแผนแรกที่คิด โดยที่รับอินพุทมา กำหนดสระ จากนั้นนำมาเข้าลูปโดยที่เก็บค่าi จากสระที่กำหนด โดยที่กำหนดให้iคือจำนวนของสระตัวนั้นๆถ้าเจอก็ให้ปริ้นออกมา 
```
...
```text
ข้อความที่มีสระหลายชนิดจะรันได้ไหม
```
...
```text
ตรวจสอบว่าสามารถแสดงจำนวนตัวอักษรทั้งหมดได้จริงมั้ย
```
