...
```text
โจทย์ให้ผมรับตัวเลขจำนวนเต็ม2ค่า คือช่วงเริ่มต้นและช่วงสิ้นสุด แล้วตรวจสอบว่าในช่วงนั้นมีจำนวนเฉพาะตัวไหนบ้าง จากนั้นแสดงจำนวนเฉพาะที่พบและบอกจำนวนทั้งหมด
```
...
```text
ผมจะรับค่า start และ endก่อนเพื่อกำหนดช่วงของตัวเลข จากนั้นก็ตรวจสอบตัวเลขแต่ละตัวว่ามีตัวเลขอื่นหารลงตัวมั้ยไม่ ถ้าไม่มีจะเก็บไว้เป็นจำนวนเฉพาะแล้วแสดงจำนวนเฉพาะทั้งหมดพร้อมจำนวนที่พบทั้งหมด
```
...
```text
วิธีสุดท้ายของผมเหมือนกับแผนแรก ผมจะตรวจตัวเลขทีละตัวในช่วงที่กำหนดโดยลองหารด้วยตัวเลขตั้งแต่ 2 ถึงก่อนตัวเลขนั้น ถ้าหารไม่ลงตัวเลยจะเก็บไว้เป็นจำนวนเฉพาะแล้วจึงแสดงจำนวนเฉพาะทั้งหมดและจำนวนที่พบ
```
...
```text
ตรวจว่าถ้าช่วงมีตัวเลขแค่ตัวเดียวโปรแกรมยังตรวจได้มัั้ย
```
...
```text
ตรวจว่าเลขติดลบและ 0, 1จะไม่ถูกนับเป็นจำนวนเฉพาะรึป่าว
```
...
```text
ตรวจว่าโปรแกรมสามารถแยกจำนวนเฉพาะตัวเดียวออกจากจำนวนอื่นๆได้ไหม
```
