...
```text
รับค่าสกอทั้งหมดมาและรับค่าสกอต่ำสุดมาเป็นinputโดยที่โจทย์ต้องการoutputเป็นข้อความว่าNot surprisingหรือSurprising 
```
...
```text
แผนแรกผมลองรับค่าinputสกอทั้งหมดและสกอสูงสุดมาก่อน จากนั้นลองหาค่าคะแนนต่ำสุดเพื่อมาหาคำตอบว่าsurprisingหรือไม่
```
...
```text
แผนสุดท้ายผมเหมือนกันแฟผนแรก คือรับค่าทั้งหมดกับค่าต่ำสุดมา แล้วนำมาหาค่าต่ำสุดโดยใช้สูตรที่เขียนไปในโจทย์จากนั้นเอามาเข้าif else โดยที่ถ้าหากว่าสกอต่ำสุดและสกอสูงสุดห่างกันไม่เกิน2 จะแสดงข้อความไม่เซอไพรซ์ แต่หากเกิน2 จะแสดงข้อความเซอไพรซ์
```
...
```text
อยากรู้ว่าถ้าหากตัวเลขมันมากๆมันจะยังทำงานปกติมั้ย
```
...
```text
อยากรู้ว่าถ้าหากค่ามันติดลบ มันจะยังทำงานได้ปกติมั้ย
```
...
```text
อยากรู้ว่าถ้าเป็นทศนิยมมันจะรันได้มั้ย สรุปว่ารันได้แต่outputไม่เป็นตามที่ต้องการ
```
...
```text
คู่pairในอาทิตย์นั้น
```

เขาช่วยอะไร

```text
เขาแนะนำเรื่องการใช้maxและสูตรต่างๆ
```

คุณยังทำอะไรด้วยตนเอง

```text
เขียนโครงสร้างโค้ดเองและนำสิ่งทีีเพื่อนสอนมาใส่ในโครงสร้างcode
```
